...
export const CCard = (props: PropsType): JSX.Element => {
    ...
    return (
        <div className={"border rounded shadow inline-block mx-2 my-4 min-w-0 flex-1"} style={{ minWidth: '500px' }}>
            <div className={"border-b text-left p-1.5 pl-4"}>{title}</div>
            <div className={"flex min-h-20"}>
                <div className={"w-1/2 text-center border-r min-h-0 flex items-center justify-center flex-col p-4"}>
                    <div className={"text-7xl"}>{leftData.quantity}</div>
