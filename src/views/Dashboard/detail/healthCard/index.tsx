    ...
    const healthyView = () => {
        return <div className={"grid grid-cols-2 h-full"}>
            <div className={"text-base"}>
                <div className={"text-lg font-bold"}>Alarms:</div>
                <div className="Alarms">
                    <div className={"flex items-center text-red-600"}>
                        <Icon
                            ...
                            fr={undefined}
                        />
                        <span className={"pl-1"}>In alarm({health.alarms.iaNum})</span>
                    </div>
                    <div className={"flex items-center text-gray-400"}>
                        <Icon
                            ...
                            fr={undefined}
                        />
                        <span className={"pl-1"}>Insufficient data({health.alarms.isNum})</span>
                    </div>
                    <div className={"flex items-center text-green-600"}>
                        <Icon
                            ...
                            fr={undefined}
                        />
                        <span className={"pl-1"}>OK({health.alarms.okNum})</span>
                    </div>
                </div>
            </div>
            <div className={"text-base"}>
